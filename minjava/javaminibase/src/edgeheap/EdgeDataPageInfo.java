...
public class EdgeDataPageInfo implements GlobalConst {
	...
	/** Constructor 
	   ...
	   */
	  public EdgeDataPageInfo(byte[] array)
	  {
	    data = array;
	    offset = 0;
	  }
	...
	/** constructor: translate a tuple to a DataPageInfo object
	   ...
	   */
	  public EdgeDataPageInfo(Edge _atuple)
	 ...
	 *
	 */
	public Edge convertToTuple() throws IOException {
		...
		Edge atuple = new Edge(data, offset, size);
