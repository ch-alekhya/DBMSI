...
public class graphDB implements GlobalConst {
    ...
    public String NodeHeapFile = "nodeHeap_File";
    public String EdgeHeapFile = "EdgeHeapFile.in";
    public String nodeLabel_BTFileName = "nodeLabel_BTFile";
    public String edgeLabel_BTFileName = "edgeLabel_BTFile";
    public String edgeWeight_BTFileName = "edgeWeight_BTFile";
    public String edgeSourceLabel_BTFileName = "edgeSourceLabel_BTFile";
    public String edgeDestinationLabel_BTFileName = "edgeDestinationLabel_BTFile";
    public String nodeDescriptor_ZTFileName = "nodeDescriptor_ZTFile";

    public NodeHeapFile nodeHeap_File;
    public EdgeHeapFile edgeHeapFile;
    public BTreeFile nodeLabel_BTFile;
    public BTreeFile edgeSourceLabelBTFile;
    public BTreeFile edgeDestLabelBTFile;
    public BTreeFile edgeLabelBTFile;
    public BTreeFile edgeWeightBTFile;
    public PCounter pcount= new PCounter();
    //public ZTreeFile nodeDescriptor_ZTFile;
     ...
     * @throws HFException 
     */
    public graphDB() throws HFException, HFBufMgrException, HFDiskMgrException, GetFileEntryException, PinPageException, ConstructPageException, IOException {
    	
    }

    public graphDB(int type) throws IOException, HFException, HFBufMgrException, HFDiskMgrException, ConstructPageException, GetFileEntryException, PinPageException {
        //nodeDescriptor_ZTFile = new ZTreeFile(this.nodeDescriptor_ZTFileName);
    	
    }
    
    
    public void initialize() throws HFException, HFBufMgrException, HFDiskMgrException, IOException, GetFileEntryException, PinPageException, ConstructPageException, AddFileEntryException{
    	nodeHeap_File = new NodeHeapFile(this.NodeHeapFile);
    	edgeHeapFile = new EdgeHeapFile(this.EdgeHeapFile);
		nodeLabel_BTFile = new BTreeFile(this.nodeLabel_BTFileName, AttrType.attrString, 100, 1);
		edgeSourceLabelBTFile = new BTreeFile(edgeSourceLabel_BTFileName, AttrType.attrString, 100, 1);
		edgeDestLabelBTFile = new BTreeFile(edgeDestinationLabel_BTFileName, AttrType.attrString, 100, 1);
		edgeLabelBTFile = new BTreeFile(edgeLabel_BTFileName, AttrType.attrString, 100, 1);
		edgeWeightBTFile = new BTreeFile(edgeWeight_BTFileName, AttrType.attrInteger, 100, 1);
		}
    ...
    public int getNodeCnt() throws HFBufMgrException, IOException, HFDiskMgrException, InvalidSlotNumberException, InvalidTupleSizeException {
        return (int)nodeHeap_File.getNodeCnt();
    }

    public int getEdgeCnt() throws HFBufMgrException, IOException, HFDiskMgrException, InvalidSlotNumberException, InvalidTupleSizeException {
        return (int)edgeHeapFile.getEdgeCnt();
    }

    public int getSourceCnt() throws HFBufMgrException, IOException, HFDiskMgrException, InvalidSlotNumberException, InvalidTupleSizeException {
        return (int)edgeHeapFile.getSourceCnt();
    }

    public int getDestinationCnt() throws HFBufMgrException, IOException, HFDiskMgrException, InvalidSlotNumberException, InvalidTupleSizeException {
        return (int)edgeHeapFile.getDestinationCnt();
    }

    public int getLabelCnt() throws HFBufMgrException, IOException, HFDiskMgrException, InvalidSlotNumberException, InvalidTupleSizeException, FieldNumberOutOfBoundException {
        return (int)(getNodeCnt() + edgeHeapFile.getLabelCnt());
    }

}//end of graphDB class